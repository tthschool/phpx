...
<?php
    ...
    // }
    // $test = new User;
    // $test->set_user_data("trinh thai hoang" , "assssdsad","hoangs","false");
    // $user  = $test->for_query_sql();
    // print_r($user);
    // $sqli = "INSERT INTO users_table (name, username, password , is_admin) VALUES (:name,:username,:password,:is_admin )";
    // $db->take_sql_from_user($sqli , $user);
    include("config.php");
